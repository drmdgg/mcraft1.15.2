...
public class MPlant extends BushBlock implements IGrowable {
	   ...
	   public MPlant(Block.Properties builder) {
	      super(builder);
	   ...
	   public void tick(BlockState state, ServerWorld worldIn, BlockPos pos, Random rand) {
	      ...
	      if (worldIn.getNeighborAwareLightSubtracted(pos, 0) >= 9) {
	   ...
	   public boolean isValidPosition(BlockState state, IWorldReader worldIn, BlockPos pos) {
	      return (worldIn.getNeighborAwareLightSubtracted(pos, 0) >= 8 || worldIn.canBlockSeeSky(pos)) && super.isValidPosition(state, worldIn, pos);
	   }
